...
class DogCardAdapter(
    ...
    private val dogeList : List<Dog> = DataSource.dogs
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        adapterLayout = if (Layout.GRID == layout) {
    ...
    override fun getItemCount(): Int = dogeList.size // TODO: return the size of the data set instead of 0
